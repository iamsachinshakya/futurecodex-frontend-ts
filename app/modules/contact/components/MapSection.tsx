      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex-1 text-center lg:text-left mb-8 lg:mb-0">
              ...
              <div className="space-y-4 mb-8">
                ...
                >
                  ...
                  <span className="text-base font-medium">+91 7500986056</span>
                </a>
              </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8">
          {[
            ...
            <div
              key={idx}
              className="group relative bg-white/5 backdrop-blur-xl rounded-2xl p-5 border border-white/10 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105 text-center"
            >
